...
public class T02FileUploadTest extends TestBase {
    ...
    */
    ...
    Path filePath2 = Path.of(System.getProperty("user.home"),"Downloads","test2.pdf");
    Path filePath3 = Path.of(System.getProperty("user.home"),"Downloads","test1.pdf");
    @Test
    ...
    public void T02FileUploadNegativeTest() throws AWTException, InterruptedException {
        ...
        String fileSTR = filePath2.toString();
        StringSelection transferableStr = new StringSelection(fileSTR);
